...
df = pd.read_csv("universities_extended_final_large_ru.csv")
...
def recommend_universities(inputs):
    ...
    return filtered.sample(n=min(10, len(filtered)))[[
        "Название университета", "Страна", "Город", "Гранты", "Стоимость проживания",
        "Краткое описание", "Язык обучения", "QS Рейтинг в стране", "QS Рейтинг в мире"
